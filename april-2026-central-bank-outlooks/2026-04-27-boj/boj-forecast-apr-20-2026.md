# Dodona Sealed Forecast: BoJ April 2026
...
The voting equilibrium includes 0 members (of 9 total actors tracked in `actors.edn`). The policy cycle is classified as **neutral**. The chair's stance is **unknown**. The equilibrium produces a **hold** forecast at 50% confidence, without a strong indicator signal.
